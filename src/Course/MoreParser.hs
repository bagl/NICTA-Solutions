...
tok p = spaces *> p <* spaces -- INFO: intentional, seems better to strip spaces on both sides
...
-- True
hex :: Parser Char
hex = replicateA 4 (satisfy isHexDigit) >>= optional failed (return . chr) . readHex
